...
figure(1);
plot(SINR,SDR_005,'-o','color',[93 163 157]/255,'Linewidth',2,'Markersize',10);
hold on;
plot(SINR,Sd_005,'-s','color',[210 57 24]/255,'Linewidth',2,'Markersize',10);
hold on;
plot(SINR,CRLB_005,'-+','color',[229 168 75]/255,'Linewidth',2,'Markersize',10);
hold on;
plot(SINR,SDR_003,'-.o','color',[93 163 157]/255,'Linewidth',2,'Markersize',10);
hold on;
plot(SINR,Sd_003,'-.s','color',[210 57 24]/255,'Linewidth',2,'Markersize',10);
hold on;
plot(SINR,CRLB_003,'-.+','color',[229 168 75]/255,'Linewidth',2,'Markersize',10);
grid on;
